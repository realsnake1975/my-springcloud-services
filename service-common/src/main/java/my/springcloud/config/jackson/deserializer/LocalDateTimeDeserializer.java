...
public class LocalDateTimeDeserializer extends JsonDeserializer<LocalDateTime> {
	...
	private static final DateTimeFormatter DTF1 = new DateTimeFormatterBuilder().appendPattern("yyyy-MM-dd'T'HH:mm:ss")
		.toFormatter();
	private static final DateTimeFormatter DTF2 = new DateTimeFormatterBuilder().appendPattern("yyyy-MM-dd HH:mm:ss")
		.toFormatter();

...
public class CustomRollingFileAppender<E> extends RollingFileAppender<E> {
    ...
    public void rollover() {
        LocalDateTime nowDatetime = LocalDateTime.parse(LocalDateTime.now().format(DtfType.yyyyMMddHHmm.dtf()), DtfType.yyyyMMddHHmm.dtf());
        LocalDateTime compDatetime = LocalDateTime.parse(startTime.get().format(DtfType.yyyyMMddHHmm.dtf()), DtfType.yyyyMMddHHmm.dtf());

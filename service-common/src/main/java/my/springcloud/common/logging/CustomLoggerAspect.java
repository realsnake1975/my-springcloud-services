...
public class CustomLoggerAspect extends LoggerAspect {
    ...
    public void loggingSuccess(JoinPoint joinPoint, Object obj) {
        ...
        String logString = super.getLogString(this.getLogDetails(ResponseCodeType.SUCCESS, cl.svcType().name(), cl.svcClassType().name(), cl.subSvcClassType().name()));
        log.info(logString);
    }
    ...
    public void loggingFail(JoinPoint joinPoint, Exception e) {
        ...
        CustomLogger cl = this.getLoggerAnnotation(joinPoint);
        String logString = super.getLogString(this.getLogDetails(responseCodeType, cl.svcType().name(), cl.svcClassType().name(), cl.subSvcClassType().name()));
        log.info(logString);
    }

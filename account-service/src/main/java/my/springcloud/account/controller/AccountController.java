...
public class AccountController {
    ...
    @GetMapping(value = "")
    public ResponseEntity find(@AuthenticationPrincipal UserDetails principal, AccountSpec spec, @PageableDefault(page = 0, size = 10) @SortDefault.SortDefaults({
    ...
    public <U extends UserDetails> ResponseEntity checkDuplicate(@AuthenticationPrincipal U principal, @PathVariable String username) {
